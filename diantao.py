...
while(len(d(text="去完成"))>0):
    ...
    if(d(text="奖励将于").exists or d(text="跳过").exists() or d(text="| 跳过").exists()):
        ...
        d.xpath('//*[@resource-id="android:id/content"]/android.widget.RelativeLayout[1]/android.widget.RelativeLayout[2]/android.widget.ImageView[1]').click_exists()
    else:
    ...
    d.xpath('//android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.ImageView[1]').click_exists()
